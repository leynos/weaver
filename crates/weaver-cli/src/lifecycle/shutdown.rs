...
/// - The timeout of 10 seconds expires before both conditions are met (`ShutdownTimeout`)
...
///
/// Returns an error if:
/// - The PID is 0 (would signal the process group) or exceeds `i32::MAX` (`InvalidPid`)
