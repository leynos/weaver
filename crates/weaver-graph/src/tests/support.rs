...
fn test_uri() -> TestResult<Uri> {
    Uri::from_str("file:///src/main.rs").map_err(|error| format!("valid URI: {error}"))
}
...
pub(super) fn item(name: &str, line: u32, column: u32) -> TestResult<CallHierarchyItem> {
...
pub(super) fn incoming_call(
    ...
    line: u32,
    column: u32,
) -> TestResult<CallHierarchyIncomingCall> {
...
pub(super) fn outgoing_call(
    ...
    line: u32,
    column: u32,
) -> TestResult<CallHierarchyOutgoingCall> {
