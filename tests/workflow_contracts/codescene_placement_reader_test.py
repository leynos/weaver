...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            "leynos/weaver/.github/workflows/release.yml@main",
            None,
            id="qualified-self",
        ),
        pytest.param(
...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            "leynos/weaver/.github/workflows/x.yml@main", True, id="qualified"
        ),
        pytest.param(
            "Leynos/Weaver/.github/workflows/x.yml@v1",
            True,
            id="qualified-case",
        ),
        pytest.param("./.github/workflows/x.yml", False, id="local"),
        pytest.param(
            "leynos/weaver/.github/workflows/x.yml", False, id="no-ref"
        ),
        pytest.param(
            "leynos/weaver-fork/.github/workflows/x.yml@main",
            False,
            id="similar-name",
        ),
        pytest.param(
            "leynos/weaver/.github/actions/setup@main", False, id="own-action"
        ),
        pytest.param(
...
def test_callers_by_ref_are_listed() -> None:
    ...
    document = load_workflow(
        ...
        "  pinned: {uses: leynos/weaver/.github/workflows/a.yml@main}\n"
    )
