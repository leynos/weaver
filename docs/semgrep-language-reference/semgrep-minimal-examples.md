...
| --------------------------------------------------------------------------- | ------------------------------------------------------------------------- | ------------------------------------------------------------ |
| `tests/syntax_v2/match.yaml`                                                | v2 `match` formula with `all`, `any`, `not`, and `inside`                 | EBNF `match-selector` and schema `match`                     |
...
| `tests/patterns/terraform/deep_expr_operator.sgrep`                         | HCL or Terraform deep ellipsis `<... ...>`                                | EBNF deep ellipsis and HCL profile                           |
