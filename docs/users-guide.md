...
| `offset`        | Deprecated compatibility spelling for older rename invocations.                                                                                        | Non-negative UTF-8 byte offset. Prefer `--position`.                                   | Cannot be combined with `--position`; malformed values fail in the selected plugin.                              |
